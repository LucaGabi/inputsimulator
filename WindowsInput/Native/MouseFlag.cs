...
{
    /// <summary>
    ///     The set of MouseFlags for use in the Flags property of the <see cref="Mouseinput" /> structure. (See:
    ...
    internal enum MouseFlag : uint // UInt32
    {
        ...
        /// <summary>
        ///     Windows NT/2000/XP: Specifies that the wheel was moved, if the mouse has a wheel. The amount of movement is
        ///     specified in mouseData.
        /// </summary>
        VerticalWheel = 0x0800,

        /// <summary>
        ///     Specifies that the wheel was moved horizontally, if the mouse has a wheel. The amount of movement is specified in
        ///     mouseData. Windows 2000/XP:  Not supported.
        /// </summary>
        ...
        /// <summary>
        ///     Specifies that the dx and dy members contain normalized absolute coordinates. If the flag is not set, dxand dy
